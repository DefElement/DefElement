...
<tr><td>`entity&#8209;ndofs`</td><td></td><td>The number of DOFs the element has per sub-entity type and the A-numbers of the [OEIS](http://oeis.org) sequence(s) giving the number of DOFs.</td></tr>
...
<tr><td>`version`</td><td>method</td><td>This method should return the version number of the implementation library.</td></tr>
