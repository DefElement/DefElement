...
for e in categoriser.elements:
    ...
    for fname in e.legacy_filenames:
        write_html_page(
            os.path.join(settings.htmlelement_path, f"{fname}.html"),
            None,
            f"This element has moved to <a href='/element/{e.html_filename}'>defelement.org/elements/{e.html_filename}</a>",
